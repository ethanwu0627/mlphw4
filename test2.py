...
def plot_confusion_matrix(confusion_matrix, save_path='lenet2_confusion_matrix.png'):
...
def plot_most_confusing_examples(misclassifications, save_path='lenet2_most_confusing.png'):
    """
...
def main():
    ...
    model = torch.load("LeNet2.pth", map_location=device, weights_only=False)
    model.eval()
